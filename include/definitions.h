...
/* Tiles */
#define TILE_SIZE 	 	16 //32
#define TILE_HEIGHT 	TILE_SIZE
#define TILE_WIDTH 		(TILE_SIZE / 2)

#define LOG_TILE_SIZE		TILE_SIZE//(TILE_SIZE / 2)
...
#define MENU_PANEL_WIDTH	(VIRTUAL_SCREEN_WIDTH / 5)
#define MENU_PANEL_HEIGHT	(VIRTUAL_SCREEN_HEIGHT / 3)
